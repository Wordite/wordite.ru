      ...
      <div className={style.content}>
        <div className={style.category}>
          ...
          <nav className={style.links}>
            <SquareLink title='First screen' number='01' type='sections' link='#hero' />
            <SquareLink title='Portfolio' number='02' type='sections' link='#portfolio' />
            <SquareLink title='Services' number='03' type='sections' link='#services' />
            <SquareLink title='Skills' number='04' type='sections' link='#skills' />
            <SquareLink title='Photos' number='05' type='sections' link='#photos' />
          </nav>
        </div>
