import twopizza from '../../assets/portfolio/twopizza.png'
...
const Twopizza = () => {
  ...
  return (
    <>
      <h1>{t('twopizza.title')}</h1>
      <h3>{t('twopizza.stack')}</h3>
      <img className='case' src={twopizza.src} alt={t('twopizza.image.alt')} />
    </>
  )
}
